...
public class FormCarga {
    ...
    public FormCarga(fxml_expedicaoController controller) {
        this.controller = controller;
    }
    ...
    private void setCbDepartamento(){
        ...
        controller.listaDepartamento = new Departamento().getLista();
    ...
    public void onReset(){
        ...
        controller.btnExcluirNota.setVisible(false);
        controller.btnCancelarNota.setVisible(false);
    ...
    public void onStageAgendado(Carga carga){
        ...
        controller.btnExcluirNota.setVisible(true);
        controller.btnExcluirNota.disableProperty().bind(controller.tblNotas.getSelectionModel().selectedItemProperty().isNull());
        controller.btnCancelarNota.setVisible(true);
        controller.btnCancelarNota.disableProperty().bind(controller.tblNotas.getSelectionModel().selectedItemProperty().isNull());

        controller.tblNotas.setVisible(true);
        ObservableList<NotaFiscal> listaNota = controller.tblExpedicao.getSelectionModel().getSelectedItem().getListaNota();
        if(listaNota.size() > 0){
            controller.tblNotas.setItems(listaNota);
        }else{
    ...
    public void onStageRecebido(Carga carga){
        ...
        controller.btnExcluirNota.disableProperty().unbind();
        controller.btnExcluirNota.setDisable(true);
        controller.btnCancelarNota.setVisible(true);
        controller.btnCancelarNota.disableProperty().bind(controller.tblNotas.getSelectionModel().selectedItemProperty().isNull());
